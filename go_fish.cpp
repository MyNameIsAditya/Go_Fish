...
int main()
{
    ...
    //myfile << "PRINT DECK::: " << d.toString() << endl;
    d.shuffle();
    //myfile << "PRINT DECK::: " << d.toString() << endl;
    ...
    myfile << p2.getName() <<"'s Number of Books:" << p2.getBookSize() << endl;         //Show secondary player's number of books
    //myfile << "PRINT DECK::: " << d.toString() << endl;
    myfile << "**************************************************" << endl;
    ...
    {
        //myfile << "HAND SIZES: " << p1.getHandSize() << " " << p2.getHandSize() << endl;
...
bool completeTurn(Deck &d, Player &primary, Player &secondary)
{
    ...
    myfile << secondary.getName() << "'s " << secondary.showBooks() << endl;                          //Show seondary player's books
    ...
    else                                                                                            //If guess is not correct
    {
        ...
        {
            myfile << primary.getName() << "'s Hand is Empty, but Deck is not Empty. Draw a Card!" << endl;
        }
        ...
        {
            myfile << "Deck is empty. Size: " << endl;
        }
    }
